...
class WolfSigmaEightStepChromaImbalanced:
    """
    Provides an imbalanced, Karras-style 9-sigma schedule
    for an 8-step sampling process.
    ...
    RETURN_TYPES = ("SIGMAS",)
    FUNCTION = "get_imbalanced_eight_step_sigmas"
    ...
    def get_imbalanced_eight_step_sigmas(
        self,
        base_start_sigma,
        base_end_sigma,
        imbalance_factor,
